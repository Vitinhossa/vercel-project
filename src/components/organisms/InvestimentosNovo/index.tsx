  ...
  const banks = [
    {
      id: 0,
      title: `Renda Fixa`,
      subtitle: `Tesouro Direto, CDB, LC, LCI, LCA, CRI, CRA e LF`,
      imageUrl: ``,
      action: (e: any) => {
        handleSelectBank(e);
      },
    },
    {
      id: 1,
      title: `Ações`,
      subtitle: `Ações de empresas Brasileiras`,
      imageUrl: ``,
      action: (e: any) => {
        handleSelectBank(e);
      },
    },
    {
      id: 1,
      title: `BDRs`,
      subtitle: `Ações de empresas estrangeiras`,
      imageUrl: ``,
      action: (e: any) => {
        handleSelectBank(e);
      },
    ...
    },
    {
      id: 1,
      title: `Subscrições`,
      subtitle: `Empresas e fundos em subscrição`,
      imageUrl: ``,
      action: (e: any) => {
        handleSelectBank(e);
      },
    },
    {
      ...
      subtitle: `Fundos de renda fixa, variável, multimercado, câmbio entre outros`,
      imageUrl: ``,
      action: (e: any) => {
        handleSelectBank(e);
      },
        ...
        <MainContainer>
          <DisplayFlex align="center" justify="center" direction="column">
            ...
            <Paragraph
              ...
              textAlign="center"
            >
              Tesouro Direto, CDB, fundos de investimento, ações e várias outras opções. Não importa há quanto tempo você sonhou. Ainda é tempo de realizar
            </Paragraph>
        ...
        <MainContainer align="flex-start">
          ...
          >
            ...
            <div style={{ maxWidth: `320px` }}>
              ...
              >
                A PixLand é segura para os seus investimentos
              </HeadingTwo>
            </div>
